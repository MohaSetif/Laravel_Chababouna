...
<body>
<form action="NewJoin" method="POST" enctype="multipart/form-data">
    @csrf
    <section>
    <div class="ImgBox">
        <img src="/img/243d2509f1657c6addbddbdba212492e.jpg">
    </div>
    ...
    <div class="InputBox">
                ...
                <div class="InputBox">
                   <span>ماذا يمكن أن تقدم للجمعية؟</span>
                   <textarea name="help" cols="80" rows="5"></textarea>
                </div>
